...
def compute_wcss(features, max_clusters=20):
    wcss = []
...
def perform_clustering_and_plot(features, n_clusters=23):
...
def main(root_path, sample_names, tile_size=128):
    for sample_name in sample_names:
        ...
        clusters, pca_result, colors = perform_clustering_and_plot(features, n_clusters=10)
