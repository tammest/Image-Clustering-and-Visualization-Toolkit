...
# =========================
# FILES - this also has the optimisation parts 
# =========================
CSV_IN = "rabbanilab/wsi_analysis/input_csv_files/n_of_3_with_rotated_coords_and_wound_info.csv"
OUTDIR = Path("kde_mode_output_granulation_only_POD")
OUTDIR.mkdir(exist_ok=True, parents=True)
OUTCSV = OUTDIR / "kde_modes_table_POD5_POD10.csv"
...
if missing:
    print(f"[warn] Missing expected POD groups in output: {missing}")
